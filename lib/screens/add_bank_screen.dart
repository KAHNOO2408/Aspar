      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(controller: bankNameController, decoration: InputDecoration(hintText: 'مثل: بانک ملی', border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)))),
            const SizedBox(height: 20),
            const Text('شماره حساب', style: TextStyle(fontWeight: FontWeight.bold)),
            const SizedBox(height: 5),
            TextField(controller: accountNumberController, decoration: InputDecoration(hintText: '1234567890', border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)))),
            const SizedBox(height: 20),
            const Text('موجودی (ریال)', style: TextStyle(fontWeight: FontWeight.bold)),
            const SizedBox(height: 5),
            TextField(controller: balanceController, keyboardType: TextInputType.number, decoration: InputDecoration(hintText: '0', border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)))),
